...
export const TRIALS: TrialTask[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: 'e2', name: '国内机构 训练营', price: 63000, rating: 4.8, imageUrl: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400', summary: '全英文讲解，1对1辅导', attributes: [{ label: '通过率', value: '86%' }, { label: '认可度', value: '行业认可' }] }
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    objectCount: 5,
    dimensionCount: 3,
    instruction: "假如你准备利用晚间时间提升AI编程能力，现在需要选一个性价比最高的课程。请选择学费10000-20000元、通过率超过99%、提供行业认证证书。",
